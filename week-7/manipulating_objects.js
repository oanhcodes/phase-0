...
I had trouble at first adding  nested properties. I was able to make it pass by stackiing the variables to add more properties and values. It works because it moves through the statement from left to right to access inner values.

How difficult was it to add and delete properties outside of the object itself?
It was not very difficult to add and delete properties outside of the object. Right now, the final output is showing [Object] for the value of the children's names for Adam. I need to return to this challenge to see if I can fix this even though my code is passing all the tests.

What did you learn about manipulating objects in this challenge?
I learned that new properties can be made using the . followed by a property name. I also learned that you can replace a property value by entering a new one.
*/
